...
_Now this is the point where I need to add this note. The explanation of the summary of the whole paper or let's say a simplification for the GAN paper that was written, it would be:_
